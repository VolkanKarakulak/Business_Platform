...
namespace Business_Platform.Migrations
{
    ...
    [Migration("20240415110118_Initial3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Business_Platform.Model.AppRole", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Business_Platform.Model.AppUser", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Business_Platform.Model.Clothing.ClothingCompanyBranch", b =>
                {
                    ...
                    b.HasOne("Business_Platform.Model.AppUser", "AppUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<long>", b =>
                {
                    b.HasOne("Business_Platform.Model.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<long>", b =>
                {
                    b.HasOne("Business_Platform.Model.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
